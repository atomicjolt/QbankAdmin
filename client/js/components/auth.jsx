...
export class Auth extends React.Component{
  ...
  // If they ever add facebook or twitter, these are the buttons:
  // <a href="" className="c-login-btn  c-login-btn--twitter"></a>
  // <a href="" className="c-login-btn  c-login-btn--facebook"></a>

  render(){
    const googleSignIn = `${this.props.rootEndpoint}authentication/signin/google`;
    return (
      <div className="o-admin-container">
        <h1 className="c-login-title">CLIx Admin</h1>
        <a href={googleSignIn} id="google" className="c-login-btn  c-login-btn--google">
          <svg width="18px" height="18px" viewBox="0 0 18 18" version="1.1" xmlns="http://www.w3.org/2000/svg">
            <g id="Google-Button" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
              <g id="btn_google_signin_light_focus_web" transform="translate(-15.000000, -15.000000)">
          ...
          <span className="c-login-btn__text">Sign in with Google</span>
        </a>
      </div>
    );
  }
